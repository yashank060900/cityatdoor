...
$city = $pincode = $state = "";
$shoptype = $shopnameerror = $shoptypeerror = $shopname = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty(trim($_POST["email"]))) {
        ...
        $sql = "SELECT sid FROM seller WHERE semail = ?";
    ...
    if (empty($shoptype)) {
        $shoptypeerror = "Shop type is required";
        $error = 1;
    }
    ...
    if ($error == 0) {
        ...
        $query = "INSERT INTO seller (sname,semail,spassword,scity,saddress,sstate,spincode,shoptype,shopname) 
                  VALUES('$name','$email','$password','$city','$address','$state','$pincode','$shoptype','$shopname')";
